  ...
  gallery: [
    {
      id: 'g1',
      asset: 'hero-01',
      alt: 'Pulverizador de aceite negro 2 en 1 lleno de aceite',
      ratio: '1/1',
      label: 'Color negro',
    },
    {
      id: 'g2',
      asset: 'hero-02',
      alt: 'Pulverizador de aceite beige 2 en 1 lleno de aceite',
      ratio: '1/1',
      label: 'Color beige',
    },
    {
      id: 'g3',
      asset: 'hero-03',
      alt: 'Pulverizador vertiendo aceite sobre una sartén',
      ratio: '1/1',
    ...
    },
    {
      id: 'g4',
      asset: 'hero-04',
      alt: 'Pulverizadores de aceite en uso durante una barbacoa',
      ratio: '1/1',
      label: 'Pulverización',
    },
    {
      id: 'g5',
      asset: 'hero-05',
      alt: 'Comparativa entre el pulverizador y otro producto',
      ratio: '1/1',
      label: 'Sin goteos',
    },
    {
      id: 'g6',
      asset: 'hero-06',
      alt: 'Pulverizador apto para distintos líquidos culinarios',
      ratio: '1/1',
